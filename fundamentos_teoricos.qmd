...
Sea $\{X(t)\}_{t \ge 0}$ una difusión estocástica continua dada por la ecuación $dX(t) = b(t, X(t)) dt + \sigma(t, X(t)) dW(t)$, y sea $V(t, x)$ una función escalar continuamente diferenciable en su componente temporal $t$ y dos veces continuamente diferenciable en su componente espacial $x$. El diferencial estocástico de la función compuesta viene dado por:
...
Considere la EDE @eq-ede-general-diff, con condición inicial $X(0) = x_0$, si se cumplen las hipotesis del teorema de existencia y unicidad @thm-existencia-unicidad y los coeficientes $b$ y de difusión $\sigma$ son continuamente diferenciables, entonces el esquema de Euler-Maruyama converge fuertemente con orden:
