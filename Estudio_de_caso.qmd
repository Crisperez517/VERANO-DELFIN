...
La Ecuación Diferencial Estocástica calibrada anteriormente nos permite simular con alta precisión la temperatura interna del refrigerador $T(t)$. Sin embargo, para evaluar el impacto en la salud pública, es imperativo traducir estas variaciones térmicas en pérdida de viabilidad del biológico.
...
* **Factor Pre-exponencial ($A$)**: Se ajusta empíricamente a **$1.2 \times 10^{14}$**. Este factor de frecuencia asegura que la tasa de degradación sea prácticamente nula cuando el equipo opera correctamente en el rango normativo de 2°C a 8°C, pero escale logarítmicamente durante una excursión térmica severa.
