...
* **Tasa Base ($\lambda_{base} = 0.0667$):** Representa el riesgo mínimo de fondo debido a fallas fortuitas o mantenimiento de la red, independiente del clima. Se calcula desde los meses más estables (febrero y noviembre, con 2 cortes al mes). Al prorratear este valor, obtenemos la tasa diaria:
...
* **Varianzas Estacionales ($\sigma_1 = 40$ y $\sigma_2 = 30$):** Controlan el ancho temporal de las afectaciones. Para la ola de calor, se asigna una desviación de $40$ días (varianza $2\sigma_1^2 = 3200$) para garantizar que la campana sea lo suficientemente ancha como para cubrir desde finales de abril (cuando inician las altas temperaturas) hasta mediados de julio. Para las lluvias, una desviación de $30$ días (varianza $2\sigma_2^2 = 1800$) modela una perturbación que cubre por completo agosto y septiembre, extendiéndose hacia octubre.
...
La suma acumulada de las 12 integrales definidas a lo largo de todo el dominio anual arrojó un valor total de **65.25 eventos esperados**. Al comparar este resultado matemático con la meta de 64 cortes empíricos, se observa que el modelo añade, en promedio, una falla anual extra. 
